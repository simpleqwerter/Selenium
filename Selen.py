...
from _skillbox_token import login, password
...
class Parser:
    ...
    def sign_in(self):
        ...
        if send_button.is_enabled():
            send_button.click()
        try:
            WebDriverWait(self.driver, 15).until(EC.title_contains("Мое обучение — Skillbox"))
    ...
    def go(self):
        ...
        if self.sign_in():
            ...
            self.driver.quit()
            print(f"request elapsed time {time() - start} sec")
